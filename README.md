...
- [phpstan-ga](https://github.com/OskarStark/phpstan-ga) - GithubAction for PHPStan  
...
- [metadata-credentials-proxy](https://github.com/Nosto/metadata-credentials-proxy) - AWS metadata credentials proxy  
...
- [baldr](https://github.com/Nosto/baldr) - ECS deployment tool  
...
## JavaScript
- [mergeable](https://github.com/mergeability/mergeable) - 🤖 All the missing GitHub automation 🙂 🙌  
...
- [eslint-action](https://github.com/gimenete/eslint-action) - GitHub action that lints your code with eslint in parallel to your builds  
...
- [macmediakeyforwarder](https://github.com/milgra/macmediakeyforwarder) - Media Key Forwarder for iTunes and Spotify  
...
## Others
- [Dato-beta](https://github.com/sindresorhus/Dato-beta) - Beta testing for the Dato app  
...
- [yay](https://github.com/marcioAlmada/yay) - Yay is a high level PHP preprocessor  
...
## Python
- [nuofx](https://github.com/caarlos0/nuofx) - Export @NuBank NuConta statements as an OFX file  
...
## Shell
- [zsh-diff-so-fancy](https://github.com/zdharma/zsh-diff-so-fancy) - The project `diff-so-fancy` (an extension for git) as a Zsh plugin  
- [reporttime](https://github.com/mstormo/reporttime) - Bash support for ZSH-like REPORTTIME  
- [magento2-tools](https://github.com/algolia/magento2-tools) - Tools for magento 2 developers  
...
## Swift
- [xcode-dev-cleaner](https://github.com/vashpan/xcode-dev-cleaner) - If you want to reclaim tens of gigabytes of your storage used for various Xcode caches - this tool is for you!  
